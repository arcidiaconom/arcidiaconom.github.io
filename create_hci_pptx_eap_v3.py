#!/usr/bin/env python3
"""
Create EAP HCI+ PowerPoint v3.
v3: 4 dedicated regional comparison slides after slide 1, removed embedded
comparisons from component slides.
"""
...
for j, (rname, rval) in enumerate(reg_stats):
    ...
    val_color = EAP_ACCENT if "East Asia" in rname else (ORANGE if rname == "World" else DARK_TEXT)
...
# ── Save ──────────────────────────────────────────────────────────────────────
output_path = "/home/user/arcidiaconom.github.io/EAP_HCI_Plus_2025_v3.pptx"
